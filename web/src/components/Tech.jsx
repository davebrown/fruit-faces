  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>I took a <a href="https://www.coursera.org/learn/machine-learning" target="_new">fairly long detour</a> through machine learning with <a href="https://www.tensorflow.org/" target="_blank">TensorFlow</a> for rudimentary image classification. <a href="https://keras.io" target="_blank">Keras</a> is a set of nice higher level abstractions for neural net definition on top of TensorFlow.
        </p>
        <p>The machine learning currently classifies each image as having a gray, blue or white plate, with ~100% accuracy. More work needed for the more sophisticated task of identifying what fruit(s) are in each image.
        </p>
        ...
        <h3>Color-thief</h3>
        <p>The early version used <a href="https://github.com/fengsp/color-thief-py">Color thief</a>, a Python library that finds dominant color in an image. I used this to figure out whether each image is on a blue plate or not, in order to make a low-res <a href="https://en.wikipedia.org/wiki/Photographic_mosaic" target="_blank">photo mosaic</a> of hearts. I've since gotten fancier with Tensorflow and Keras classification.</p>
        ...
        <ul>
          ...
          <li><span className="strike">Deploy via <a href="https://skyliner.io" target="_blank">Skyliner</a>.</span></li>
          ...
          <li><span className="strike">Multi-user</span></li>
          <li><span className="strike">At least a modicum of tests :-)</span></li>
        </ul>
        <FBBlock like={false}/>
      </div>
           );
